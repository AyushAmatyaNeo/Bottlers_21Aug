    ...
    $(document).ready(function () {
        ...
        var action = `
            <div class="clearfix">
                ...
                #}#
                #if(REQUESTED_TYPE=='ad' && ALLOW_EDIT=='Y' && ITNARY_CHECK=='N'){#
                    <a class="btn btn-icon-only yellow" href="${document.editLink}/#:TRAVEL_ID#" style="height:17px;" title="View Detail">
               <i class="fa fa-edit"></i>
            </a>
                    #}else{#
                    <a class="btn btn-icon-only yellow" href="${document.editExpenseLink}/#:TRAVEL_ID#" style="height:17px;" title="View Expense Detail">
                        <i class="fa fa-edit"></i>
                    </a>
                    #}#
